import{b as me,g as be,a as Re,_ as we,r as X,S as Te}from"./firebase-core-COSghHnU.js";import{t as P,f as ke,e as Q,p as ye,u as Ee,h as Ae,F as Ue,C as Oe}from"./firebase-DsjMOuOd.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let c=!1;function d(...p){c||(c=!0,t.apply(null,p))}function b(p){r=setTimeout(()=>{r=null,e(R,u())},p)}function m(){o&&clearTimeout(o)}function R(p,...I){if(c){m();return}if(p){m(),d.call(null,p,...I);return}if(u()||i){m(),d.call(null,p,...I);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,b(T)}let w=!1;function y(p){w||(w=!0,m(),!c&&(r!==null?(p||(a=2),clearTimeout(r),b(0)):p||(a=1)))}return b(0),o=setTimeout(()=>{i=!0,y(!0)},n),y}function ze(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="storage";function $t(e,t,n){return e=P(e),It(e,t,n)}function jt(e){return e=P(e),Nt(e)}function qt(e){return e=P(e),Ct(e)}function Vt(e,t){return e=P(e),St(e,t)}function Wt(e=be(),t){e=P(e);const s=me(e,_e).getImmediate({identifier:t}),r=ke("storage");return r&&vt(s,...r),s}function vt(e,t,n,s={}){Lt(e,t,n,s)}function Bt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new z(n,s,r,t,Te)}function Ft(){we(new Oe(_e,Bt,"PUBLIC").setMultipleInstances(!0)),X(Z,J,""),X(Z,J,"esm2020")}Ft();export{h as StorageError,l as StorageErrorCode,k as StringFormat,E as _FbsBlob,g as _Location,it as _dataFromString,H as _invalidArgument,qe as _invalidRootOperation,vt as connectStorageEmulator,qt as deleteObject,jt as getDownloadURL,Wt as getStorage,Vt as ref,$t as uploadBytes};
