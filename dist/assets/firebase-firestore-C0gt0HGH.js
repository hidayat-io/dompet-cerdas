 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ff(r){return qn(r=ie(r,ve)),new If(r,(e=>Gn(r,e)))}(function(e,t=!0){(function(s){jt=s})(Cc),Pc(new xc("firestore",((n,{instanceIdentifier:s,options:i})=>{const o=n.getProvider("app").getImmediate(),a=new ve(new Qc(n.getProvider("auth-internal")),new Jc(o,n.getProvider("app-check-internal")),(function(c,l){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new p(m.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new at(c.options.projectId,l)})(o,s),o);return i={useFetchStreams:t,...i},a._setSettings(i),a}),"PUBLIC").setMultipleInstances(!0)),Ni(Mi,Fi,e),Ni(Mi,Fi,"esm2020")})();export{Mf as a,Pf as b,wf as c,rf as d,Sf as e,Df as f,Rf as g,xf as h,vf as i,Nf as o,kf as p,Vf as q,bf as s,Cf as u,Ff as w};
